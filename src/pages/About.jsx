          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden"
              ...
              <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-700">
                ...
                <button onClick={() => setProofModal(null)} className="p-2 text-gray-400 hover:text-gray-600 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
                  ✕
                </button>
              </div>
              ...
              <div className="p-6 border-t border-gray-100 dark:border-gray-700 flex justify-end">
                <a href={proofModal.proofUrl} target="_blank" rel="noreferrer"
                  className="flex items-center gap-2 px-6 py-2 bg-orange-500 text-white rounded-full font-medium hover:bg-orange-600 transition">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a href={d.facebookLink || defaultData.facebookLink} target="_blank" rel="noreferrer"
                className="px-5 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-full font-medium transition">
                Facebook
              </a>
              <a href={d.medilogyLink || defaultData.medilogyLink} target="_blank" rel="noreferrer"
                className="px-5 py-2 bg-white/40 dark:bg-gray-700/40 border border-white/30 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-full font-medium hover:bg-white/60 transition">
                Medilogy
              </a>
            </div>
          </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {item.proofUrl && (
                          <button
                            ...
                            className="mt-3 flex items-center gap-2 px-4 py-1.5 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-full text-xs font-medium hover:bg-orange-200 dark:hover:bg-orange-900/50 transition"
                          >
